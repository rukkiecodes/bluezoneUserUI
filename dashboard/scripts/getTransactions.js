(async () => {
  ...
  if (transactions.data.transactions.length > 0) {
                                ...
                                <a href="#" class="item">
                                    ...
                                    <div class="in">
                                        <div>
                                            ...
                                            <div class="text-small text-secondary font-weight-bold ${item.status == 'PENDING' ? 'text-warning' : 'text-dark'}">${item.status}</div>
                                        </div>
                                        <div class="text-end">
    ...
    getTransactions.innerHTML += ` <div class="section mt-2"
